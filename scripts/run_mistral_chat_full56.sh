...
python mcq_experiments_mistral.py --test_filename "preprocessed_data/pure_casing_test_dataset.json" --examples_filename "preprocessed_data/pure_casing_examples_full.json" --model "mistralai/Mistral-7B-Instruct-v0.1" --subfolder mistral_chat_full --run_str mistral_chat_full2 --n_examples 5 6 --samples 30 30 --seed_start 1000

python mcq_experiments_mistral.py --test_filename "preprocessed_data/pure_casing_test_dataset.json" --examples_filename "preprocessed_data/pure_casing_examples_full.json" --model "mistralai/Mistral-7B-Instruct-v0.1" --subfolder mistral_chat_full --run_str mistral_chat_full_oneprompt2 --n_examples 5 6 --samples 30 30 --seed_start 1000 --oneprompt