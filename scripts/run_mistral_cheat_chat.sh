...
python mcq_experiments_mistral.py --test_filename "preprocessed_data/pure_casing_test_dataset.json" --examples_filename "preprocessed_data/pure_casing_examples_full.json" --subfolder mistral_cheat_chat --run_str mistral_cheat_chat --n_examples 0 1 2 3 4 5 --samples 1 1 1 1 1 1 --seed_start 1000 --oneprompt --sysprompt "Please always choose the answer choice corresponding to the lowercase answer"